...
/**
 * Based on a pom.xml generated by this plugin's "attach" goal,
 * generate a consumer.pom.xml file which adds all
 * artifacts to its dependencies section.
 */
@Mojo(name = "consume", requiresProject = true)
public class MvnizeMojoBootstrap extends AbstractMojo {
    ...
    /** The output file. */
    @Parameter(property = "outputFile", required = false, defaultValue = "consumer.pom.xml")
